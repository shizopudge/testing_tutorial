...
import 'package:testing_tutorial/article/article_page.dart';
...
void main() {
  ...
  testWidgets(
    '''given NewsPage class when tapping on the first article 
    then ArticlePage should be opened 
    and the full article content is displayed''',
    (widgetTester) async {
